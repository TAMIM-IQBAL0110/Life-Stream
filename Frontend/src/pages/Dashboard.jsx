  ...
  return (
    <div className="bg-[#f8f6f6]">
      <div className="view-container flex-1 max-w-6xl mx-auto w-full p-4 lg:p-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-8 bg-white  rounded-xl shadow-sm border border-[#ea2a33]/5">
          ...
          <button
            className="flex min-w-35 cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-12 px-6 bg-[#ea2a33] text-white text-sm font-bold shadow-lg shadow-[#ea2a33]/20 hover:bg-[#ea2a33]/90 transition-all"
            onClick={onEdit}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="flex flex-col gap-3 rounded-xl p-6 bg-white border border-[#ea2a33]/10 hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-col gap-3 rounded-xl p-6 bg-white border-[#ea2a33]/10 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3">
            ...
            <p className="text-slate-900 text-2xl font-extrabold">12 Lives</p>
            <p className="text-xs text-slate-400">
              Based on 4 successful donations
            </p>
          </div>
          [4/5/2026 5:21 PM] Fahimul Kadir:{" "}
          <div className="flex flex-col gap-3 rounded-xl p-6 bg-white border border-[#ea2a33]/10 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3">
            ...
            {eligible_to_donate ? (
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-2">
                  Not eligible for the donation
                </p>
              </div>
            )}
          </div>
          <div className="flex flex-col justify-between gap-6 rounded-xl border border-[#ea2a33]/10 bg-white  p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-slate-500  text-sm leading-relaxed">
                  Toggle your status to let hospitals and patients know if you
                  are ready to donate blood right now.
                </p>
              </div>
            </div>
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 ">
              {available ? (
                <span className="text-sm font-bold text-[#ea2a33]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="max-w-full">
              ...
              <p className="text-white/80 text-sm">
                Drink plenty of water and have a healthy meal before you visit
                the donation center!
              </p>
              <p className="text-white/80 text-sm">
          ...
          <div className="grid gap-6 rounded-xl p-7 w-full bg-white shadow-xl">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div className="grid gap-2">
                ...
                <input
                  className="text-sm ring-1 ring-slate-200 py-2 px-3 rounded-md w-full focus:ring-red-500 focus:ring-2 outline-0"
                  type="text"
                  value={user.name}
            ...
            <div className="grid gap-2 ">
              ...
              <div className="relative">
                <input
                  className="text-sm ring-1 ring-slate-200 py-2 px-9 rounded-md w-full focus:ring-red-500 focus:ring-2 outline-0"
                  type="text"
                  value={user.location}
                  onChange={(e) => setuser(e.target.value)}
                />
                <span className="material-symbols-outlined text-slate-400 absolute top-1.5 left-2">
                  location_on
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 md:flex-row md:justify-end">
              <button
                className="bg-white w-full text-slate-500 py-2.5 px-7 font-bold rounded-lg text-sm hover:bg-slate-100 cursor-pointer md:w-auto"
                onClick={onBack}
              >
                Cancel
              </button>
              <button
                className="bg-red-600 w-full text-white py-2.5 px-7 font-bold rounded-lg text-sm shadow-md hover:bg-red-500 cursor-pointer md:w-auto"
                onClick={() => {
                  alert(
                    user.name +
                      " " +
